...
public class ItemControllerTest {
    ...
    @Test
    void getOneItem() {
        webTestClient.get().uri(ITEM_END_POINT_V1.concat("/{id}"), "My id")
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    @Test
    void deleteItem() {
        webTestClient.delete().uri(ITEM_END_POINT_V1.concat("/{id}"), "My id")
                .exchange()
                .expectStatus().isOk()
    ...
    void updateItem() {
        ...
        webTestClient.put().uri(ITEM_END_POINT_V1.concat("/{id}"), "My id")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    void updateItem_notFound() {
        ...
        webTestClient.put().uri(ITEM_END_POINT_V1.concat("/{id}"), "id")
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON)
                .body(Mono.just(item), Item.class)
                .exchange()
    ...
    void runtTimeException() {
        webTestClient.get().uri(ITEM_END_POINT_V1.concat("/runtimeException"))
            .exchange()
